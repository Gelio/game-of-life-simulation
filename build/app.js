	...
	var Header = function (_React$Component) {
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "h1",
	                { className: "text-xs-center text-primary" },
	                "The Game of Life"
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapClass = __webpack_require__(170);

	var _mapClass2 = _interopRequireDefault(_mapClass);

	var _Settings = __webpack_require__(171);
	...
	var Game = function (_React$Component) {
	    ...
	    function Game() {
	        ...
	        _this.state = {
	            map: Object.create(_mapClass2.default),
	            paused: false,
	            speed: _config2.default.defaultSpeed // just the index
	        };
	        _this.state.map.init();
	        _this.state.map.randomMap();

	        _this.state.interval = setInterval(_this.tick.bind(_this), _config2.default.speeds[_config2.default.defaultSpeed]);
	        return _this;
	    }
	    ...
	    _createClass(Game, [{
	        ...
	        value: function setPausedState(isPaused) {
	            ...
	            if (!isPaused) this.setGameSpeed(this.state.speed);
	        }
	    }, {
	        key: 'clearMap',
	        ...
	        key: 'setGameSpeed',
	        value: function setGameSpeed(newSpeed) {
	            clearInterval(this.state.interval);
	            this.setState({
	                speed: newSpeed,
	                paused: false,
	                interval: setInterval(this.tick.bind(this), _config2.default.speeds[newSpeed])
	            });
	        }
	    }, {
	        key: 'setMapSize',
	        value: function setMapSize(newMapSize) {
	            if (!this.state.paused) return console.log('Game needs to be paused to update map size');
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Settings2.default, { map: this.state.map, paused: this.state.paused, speed: this.state.speed,
	                ...
	                _react2.default.createElement(_Map2.default, { map: this.state.map,
...
/***/ function(module, exports, __webpack_require__) {
	...
	function init(sizeIndex) {
	    if (sizeIndex === undefined || sizeIndex < 0 || sizeIndex >= _config2.default.mapSizes.length) sizeIndex = _config2.default.defaultMapSize;

	    this.mapSize = _config2.default.mapSizes[sizeIndex];
	    ...
	    for (var i = 0; i < this.mapSize[1]; i++) {
	        ...
	        } // 0 indicates that the cell is dead
	    }
	...
	function randomMap(elements) {
	    if (!elements) elements = _config2.default.randomElements * this.mapSize[0] * this.mapSize[1];
	...
	function tick() {
	    ...
	    this.gameMap.forEach(function (row, columnIndex) {
	        newMap.push([]);
	        row.forEach(function (cell, rowIndex) {
	            var aliveNeighbours = _this.countActiveCellsAround(rowIndex, columnIndex),
	                isActive = cell;

	            if (isActive && (aliveNeighbours < 2 || aliveNeighbours > 3)) isActive = 0;else if (!isActive && aliveNeighbours == 3) isActive = 1;
	...
	function countActiveCellsAround(x, y) {
	    ...
	    if (x == 0) minX = 0;
	    if (x == this.mapSize[0] - 1) maxX = 0;

	    if (y == 0) minY = 0;
	    if (y == this.mapSize[1] - 1) maxY = 0;

	    for (var i = minX; i <= maxX; i++) {
	        for (var j = minY; j <= maxY; j++) {
	            if (i == 0 && j == 0) continue;

	            if (this.gameMap[y + j][x + i]) count++;
	        }
	    }return count;
	}
	...
	function clearMap() {
	    ...
	    this.gameMap.forEach(function (row, columnIndex) {
	        row.forEach(function (cell, rowIndex) {
	            _this2.gameMap[columnIndex][rowIndex] = 0;
	        });
	    });
	    this.generations = 0;
	...
	function switchCell(x, y) {
	    if (this.gameMap[y][x]) this.gameMap[y][x] = 0;else this.gameMap[y][x] = 1;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Settings = function (_React$Component) {
	    ...
	    function Settings() {
	        ...
	        _this.state = {
	            selectedMapSize: _config2.default.defaultMapSize
	        };
	        return _this;
	    }
	    ...
	    _createClass(Settings, [{
	        ...
	        key: 'setGameSpeed',
	        value: function setGameSpeed(newGameSpeed) {
	            this.props.setGameSpeed(newGameSpeed);
	        }
	    }, {
	        key: 'disableButtonWhileRunning',
	        value: function disableButtonWhileRunning() {
	        ...
	        value: function getButtons() {
	            ...
	            if (this.props.paused) buttons.push(_react2.default.createElement(_Button2.default, { title: 'Resume', style: 'btn-primary', click: this.props.resumeGame, key: '0' }));else buttons.push(_react2.default.createElement(_Button2.default, { title: 'Pause', style: 'btn-primary', click: this.props.pauseGame, key: '0' }));

	            buttons.push(_react2.default.createElement(_Button2.default, { title: 'Clear', style: 'btn-secondary', click: this.clearMap.bind(this), key: '1' }));
	            buttons.push(_react2.default.createElement(_Button2.default, { title: 'Randomize', style: 'btn-secondary', click: this.props.randomize, key: '2' }));

	            // Second row - map sizes
	            _config2.default.mapSizes.forEach(function (mapSize, i) {
	                buttons.push(_react2.default.createElement(_Button2.default, { title: mapSize[0] + 'x' + mapSize[1], style: 'btn-secondary', disabled: _this2.disableButtonWhileRunning(), click: _this2.setMapSize.bind(_this2, i), key: buttons.length }));
	            });

	            // Third row - game speeds
	            _config2.default.speeds.forEach(function (speed, i) {
	                buttons.push(_react2.default.createElement(_Button2.default, { title: _config2.default.speedLabels[i], style: 'btn-secondary', click: _this2.setGameSpeed.bind(_this2, i), key: buttons.length }));
	            });
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'col-md-8 col-md-push-2 text-xs-center clearfix' },
	                ...
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    buttons.slice(3, 3 + _config2.default.mapSizes.length)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    buttons.slice(3 + _config2.default.mapSizes.length, 3 + _config2.default.mapSizes.length + _config2.default.speeds.length)
	                ),
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    'Generations: ',
	                    this.props.map.generations
	                )
	            );
	        }
	    }]);
	...
	var Settings = function (_React$Component) {
	    ...
	    _createClass(Settings, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'button',
	                { role: 'button', className: "settings-button btn " + this.props.style, disabled: this.isDisabled(), onClick: this.props.click },
	                this.props.title
	            );
	        }
	    }]);
	...
	var Map = function (_React$Component) {
	    ...
	    _createClass(Map, [{
	        ...
	        value: function getCells() {
	            ...
	            gameMap.forEach(function (row, y) {
	                ...
	                row.forEach(function (cell, x) {
	                    cells[cells.length - 1].push(_react2.default.createElement(_Cell2.default, { key: index, status: _this2.props.map.getCellStatus(x, y), switchCell: _this2.switchCell.bind(_this2, x, y), width: 100 / _this2.props.map.mapSize[0] }));
	                    index++;
	                });
	            });
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'col-md-8 col-md-push-2 m-t-2' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'game-map' },
	                    this.getCells().map(function (row, i) {
	                        return _react2.default.createElement(
	                            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = function (_React$Component) {
	    ...
	    _createClass(Cell, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { className: this.getClass(), onClick: this.props.switchCell, style: { width: this.props.width + "%" } });
	        }
	    }]);
